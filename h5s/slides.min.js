...
function getCurSlideFromHash(){var a=parseInt(location.hash.substr(1));a?(SLIDESHOW_MODE=1,curSlide=a-1):curSlide=0}function updateHash(){location.replace("#"+(curSlide+1))}function eraseHash(){location.replace("#")}
...
function addMeta(){var a=document.createElement("meta");a.name="viewport";a.content="width=1100,height=750";document.querySelector("head").appendChild(a)}function rmMeta(){document.getElementsByTagName("meta");for(var a,b=0;a=meta[b];b++)"viewport"==a.name&&document.querySelector("head").removeChild(a)}function makeBuildLists(){for(var a=curSlide,b;b=slideEls[a];a++){b=b.querySelectorAll(".build > *");for(var c=0,d;d=b[c];c++)d.classList&&d.classList.add("to-build")}}
